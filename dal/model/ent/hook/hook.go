...
// The MenuSpecFunc type is an adapter to allow the use of ordinary
// function as MenuSpec mutator.
type MenuSpecFunc func(context.Context, *ent.MenuSpecMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MenuSpecFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MenuSpecMutation); ok {
		return f(ctx, mv)
	}
...
// The TableCategoryFunc type is an adapter to allow the use of ordinary
// function as TableCategory mutator.
type TableCategoryFunc func(context.Context, *ent.TableCategoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TableCategoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TableCategoryMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TableCategoryMutation", m)
}
