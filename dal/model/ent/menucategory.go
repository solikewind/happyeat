...
func (e MenuCategoryEdges) MenusOrErr() ([]*Menu, error) {
	if e.loadedTypes[0] {
		return e.Menus, nil
	}
...
func (*MenuCategory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case menucategory.FieldID, menucategory.FieldDeleteTs:
...
func (_m *MenuCategory) assignValues(columns []string, values []any) error {
...
func (_m *MenuCategory) Value(name string) (ent.Value, error) {
...
func (_m *MenuCategory) Update() *MenuCategoryUpdateOne {
	return NewMenuCategoryClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the MenuCategory entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *MenuCategory) Unwrap() *MenuCategory {
...
func (_m *MenuCategory) String() string {
